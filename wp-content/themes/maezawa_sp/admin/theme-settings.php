...
$ad_layout = array("Above Logo","Right of Logo");
...
$options[] = array( "name" => __('Featured Posts Font','framework_localize'),
			"desc" => __('Select the font for the Featured Posts section on the homepage and category pages.','framework_localize'),
...
$options[] = array( "name" => __('Homepage Featured Posts Tag Slug','framework_localize'),
			"desc" => __('Posts with tags in this field will show up in the featured area on the homepage.','framework_localize'),
