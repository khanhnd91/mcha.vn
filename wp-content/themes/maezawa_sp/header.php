...
<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# article: http://ogp.me/ns/article#">
    ...
    <script type="text/javascript" src="<?php bloginfo('template_directory'); ?>/js/drawer.min.js"></script>
    <script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
    <script>
        // Store template URL.
        window.MCHA_URL = window.MCHA_URL || {};
        MCHA_URL.template = '<?php bloginfo('template_directory') ?>';
    </script>
    ...
    if (is_single() or is_page()){ // 投稿記事
        ...
        echo '<meta property="og:title" content="'; wp_title( '| MATCHA - JAPAN TRAVEL WEB MAGAZINE', true, 'right' ); echo '">';echo "\n";//「一般設定」で入力したブログのタイトル
    ...
    if (is_single() or is_page()){//投稿記事か固定ページの場合
        if (has_post_thumbnail()){//アイキャッチがある場合
            ...
            echo '<meta property="og:image" content="http://mcha-jp.com.s3-ap-northeast-1.amazonaws.com/wp-content/uploads/2016/02/03182644/matcha_logo_facebook.jpg">';echo "\n";
        }
    ...
    <?php
    if(is_home()){
        print "<title>MATCHA - JAPAN TRAVEL WEB MAGAZINE</title>";
    }else{
        print "<title>";
            single_post_title();
            print "| MATCHA - JAPAN TRAVEL WEB MAGAZINE</title>";
        }
        ?>
