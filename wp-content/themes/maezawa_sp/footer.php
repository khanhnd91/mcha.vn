      ...
      <div class="footer_contents">
        <div class="footer_menu">
          <a href="<?php bloginfo('home'); ?>/about">
            <p><?php if($jp_flg){ echo "MATCHAとは"; }else{echo "About";} ?>
            </p>
          </a>
          
          <a href="<?php bloginfo('home'); ?>/partner">
            <p><?php if($jp_flg){ echo "パートナーメディア"; }else{echo "Partner Media";} ?>
            </p>
          </a>
        ...
        <div class="footer_sns">
          <p><?php if($jp_flg){ echo "ソーシャルメディア"; }else{echo "SocialMedia";} ?>
          </p>
