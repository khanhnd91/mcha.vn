...
class ht_carousel_widget extends WP_Widget {
	...
	function ht_carousel_widget() {
		...
		/* Create the widget. */
		$this->WP_Widget( 'ht_carousel_widget', __('Hot Topix: Carousel Widget', 'ht_carousel_widget'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		<!-- Tag -->
		<p>
			<label for="<?php echo $this->get_field_id('tags'); ?>">Select a tag:</label>
